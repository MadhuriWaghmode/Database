...
public class ut extends javax.swing.JFrame {
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(st1, javax.swing.GroupLayout.PREFERRED_SIZE, 97, javax.swing.GroupLayout.PREFERRED_SIZE)
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addGap(124, 124, 124)
                                .addComponent(st3, javax.swing.GroupLayout.PREFERRED_SIZE, 63, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(st4)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addComponent(st2, javax.swing.GroupLayout.PREFERRED_SIZE, 75, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(37, 37, 37)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                ...
                                .addComponent(jLabel4))
                            .addComponent(st3, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void snActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_snActionPerformed
        ...
        String str3=null;
        String str4=null;
        if(st1.getText().isEmpty() && st2.getText().isEmpty() && st3.getText().isEmpty() && st4.getText().isEmpty())
        {
            JOptionPane.showMessageDialog(this,"where set can not be empty");
        }
        else
        {
           if(st1.getText().toString().isEmpty()==false && st2.getText().toString().isEmpty() &&st3.getText().toString().isEmpty()&&st4.getText().toString().isEmpty())
           {
               sql="UPDATE "+jComboBox1.getSelectedItem()+" SET  "+"`"+cl1.getText()+"`"+"="+"'"+st1.getText()+"'"+"  WHERE ";
           }
           else if(st1.getText().toString().isEmpty() && st2.getText().toString().isEmpty()==false &&st3.getText().toString().isEmpty()&&st4.getText().toString().isEmpty())
            {
                sql="UPDATE "+jComboBox1.getSelectedItem()+" SET  "+"`"+cl2.getText()+"`"+"="+"'"+st2.getText()+"'"+"  WHERE ";
            }
           else if(st1.getText().toString().isEmpty() && st2.getText().toString().isEmpty()&&st3.getText().toString().isEmpty()==false&&st4.getText().toString().isEmpty())
            {
                sql="UPDATE "+jComboBox1.getSelectedItem()+" SET  "+"`"+cl3.getText()+"`"+"="+"'"+st3.getText()+"'"+"  WHERE ";
            }
           else if(st1.getText().toString().isEmpty() && st2.getText().toString().isEmpty() &&st3.getText().toString().isEmpty()&&st4.getText().toString().isEmpty()==false)
            {
                sql="UPDATE "+jComboBox1.getSelectedItem()+" SET  "+"`"+cl4.getText()+"`"+"="+"'"+st4.getText()+"'"+"  WHERE ";
            }
           else if(st1.getText().toString().isEmpty()==false&& st2.getText().toString().isEmpty()==false &&st3.getText().toString().isEmpty()&&st4.getText().toString().isEmpty())
            {
                sql="UPDATE "+jComboBox1.getSelectedItem()+" SET  "+"`"+cl1.getText()+"`"+"="+st1.getText()+" ,"+"`"+cl2.getText()+"`"+"="+"'"+st2.getText()+"'"+"  WHERE ";
            }
            else if(st1.getText().toString().isEmpty()==false&& st2.getText().toString().isEmpty()&&st3.getText().toString().isEmpty()==false &&st4.getText().toString().isEmpty())
            {
                sql="UPDATE "+jComboBox1.getSelectedItem()+" SET  "+"`"+cl1.getText()+"`"+"="+st1.getText()+" , "+"`"+cl3.getText()+"`"+"="+"'"+st3.getText()+"'"+"  WHERE ";
            }
           else if(st1.getText().toString().isEmpty()==false&& st2.getText().toString().isEmpty()&&st3.getText().toString().isEmpty() &&st4.getText().toString().isEmpty()==false)
            {
                sql="UPDATE "+jComboBox1.getSelectedItem()+" SET  "+"`"+cl1.getText()+"`"+"="+st1.getText()+" , "+"`"+cl4.getText()+"`"+"="+"'"+st4.getText()+"'"+"  WHERE ";
            }
           else if(st1.getText().toString().isEmpty()&& st2.getText().toString().isEmpty()==false&&st3.getText().toString().isEmpty() &&st4.getText().toString().isEmpty()==false)
            {
                sql="UPDATE "+jComboBox1.getSelectedItem()+" SET  "+"`"+cl2.getText()+"`"+"="+st2.getText()+" ,"+"`"+cl4.getText()+"`"+"="+"'"+st4.getText()+"'"+"  WHERE ";
            }
           else if(st1.getText().toString().isEmpty()&& st2.getText().toString().isEmpty()==false&&st3.getText().toString().isEmpty()==false&&st4.getText().toString().isEmpty())
            {
                sql="UPDATE "+jComboBox1.getSelectedItem()+" SET  "+"`"+cl2.getText()+"`"+"="+st2.getText()+" , "+"`"+cl3.getText()+"`"+"="+"'"+st3.getText()+"'"+"  WHERE ";
            }
            else if(st1.getText().toString().isEmpty()&& st2.getText().toString().isEmpty()&&st3.getText().toString().isEmpty()==false&&st4.getText().toString().isEmpty()==false)
            {
                sql="UPDATE "+jComboBox1.getSelectedItem()+" SET  "+"`"+cl3.getText()+"`"+"="+st3.getText()+" ,"+"`"+cl4.getText()+"`"+"="+"'"+st4.getText()+"'"+"  WHERE ";
            }
           else if(st1.getText().toString().isEmpty()==false&& st2.getText().toString().isEmpty()==false&&st3.getText().toString().isEmpty()==false&&st4.getText().toString().isEmpty())
            {
                sql="UPDATE "+jComboBox1.getSelectedItem()+" SET  "+"`"+cl1.getText()+"`"+"="+st1.getText()+" ,"+"`"+cl2.getText()+"`"+"="+st2.getText()+","+"`"+cl3.getText()+"`"+"="+"'"+st3.getText()+"'"+ "  WHERE ";
            }
            else if(st1.getText().toString().isEmpty()==false&& st2.getText().toString().isEmpty()==false&&st3.getText().toString().isEmpty()&&st4.getText().toString().isEmpty()==false)
            {
                sql="UPDATE "+jComboBox1.getSelectedItem()+" SET  "+"`"+cl1.getText()+"`"+"="+st1.getText()+" , "+"`"+cl2.getText()+"`"+"="+st2.getText()+" ,"+"`"+cl4.getText()+"`"+"="+"'"+st4.getText()+"'"+ "  WHERE ";
            }
           else if(st1.getText().toString().isEmpty()&& st2.getText().toString().isEmpty()==false&&st3.getText().toString().isEmpty()==false&&st4.getText().toString().isEmpty()==false)
            {
                sql="UPDATE "+jComboBox1.getSelectedItem()+" SET  "+"`"+cl2.getText()+"`"+"="+st2.getText()+","+"`"+cl3.getText()+"`"+"="+st3.getText()+","+"`"+cl4.getText()+"`"+"="+"'"+st4.getText()+"'"+ "  WHERE ";
            }
            else if(st1.getText().toString().isEmpty()==false&& st2.getText().toString().isEmpty()==false&&st3.getText().toString().isEmpty()==false&&st4.getText().toString().isEmpty()==false)
            {
                sql="UPDATE "+jComboBox1.getSelectedItem()+" SET  "+"`"+cl1.getText()+"`"+"="+st1.getText()+" , "+"`"+cl2.getText()+"`"+"="+st2.getText()+" ,"+"`"+cl3.getText()+"`"+"="+st3.getText()+","+"`"+cl4.getText()+"`"+"="+"'"+st4.getText()+"'"+ "  WHERE ";
            }
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
        ...
        {
           if(st1.getText().isEmpty()==false && st2.getText().isEmpty() &&st3.getText().isEmpty()&&st4.getText().isEmpty())
           {
               sql="UPDATE "+jComboBox1.getSelectedItem()+" SET  "+"`"+cl1.getText()+"`"+"="+st1.getText()+"  WHERE ";
           }
           else if(st1.getText().isEmpty() && st2.getText().isEmpty()==false &&st3.getText().isEmpty()&&st4.getText().isEmpty())
            {
                sql="UPDATE "+jComboBox1.getSelectedItem()+" SET  "+"`"+cl2.getText()+"`"+"="+st2.getText()+"  WHERE ";
            }
           else if(st1.getText().isEmpty() && st2.getText().isEmpty()&&st3.getText().isEmpty()==false&&st4.getText().isEmpty())
            {
                sql="UPDATE "+jComboBox1.getSelectedItem()+" SET  "+"`"+cl3.getText()+"`"+"="+st3.getText()+"  WHERE ";
            }
           else if(st1.getText().isEmpty() && st2.getText().isEmpty() &&st3.getText().isEmpty()&&st4.getText().isEmpty()==false)
            {
                sql="UPDATE "+jComboBox1.getSelectedItem()+" SET  "+"`"+cl4.getText()+"`"+"="+st4.getText()+"  WHERE ";
            }
           else if(st1.getText().isEmpty()==false&& st2.getText().isEmpty()==false &&st3.getText().isEmpty()&&st4.getText().isEmpty())
            {
                sql="UPDATE "+jComboBox1.getSelectedItem()+" SET  "+"`"+cl1.getText()+"`"+"="+st1.getText()+" ,"+"`"+cl2.getText()+"`"+"="+st2.getText()+"  WHERE ";
            }
            else if(st1.getText().isEmpty()==false&& st2.getText().isEmpty()&&st3.getText().isEmpty()==false &&st4.getText().isEmpty())
            {
                sql="UPDATE "+jComboBox1.getSelectedItem()+" SET  "+"`"+cl1.getText()+"`"+"="+st1.getText()+" , "+"`"+cl3.getText()+"`"+"="+st3.getText()+"  WHERE ";
            }
           else if(st1.getText().isEmpty()==false&& st2.getText().isEmpty()&&st3.getText().isEmpty() &&st4.getText().isEmpty()==false)
            {
                sql="UPDATE "+jComboBox1.getSelectedItem()+" SET  "+"`"+cl1.getText()+"`"+"="+st1.getText()+" , "+"`"+cl4.getText()+"`"+"="+st4.getText()+"  WHERE ";
            }
           else if(st1.getText().isEmpty()&& st2.getText().isEmpty()==false&&st3.getText().isEmpty() &&st4.getText().isEmpty()==false)
            {
                sql="UPDATE "+jComboBox1.getSelectedItem()+" SET  "+"`"+cl2.getText()+"`"+"="+st2.getText()+" ,"+"`"+cl4.getText()+"`"+"="+st4.getText()+"  WHERE ";
            }
           else if(st1.getText().isEmpty()&& st2.getText().isEmpty()==false&&st3.getText().isEmpty()==false&&st4.getText().isEmpty())
            {
                sql="UPDATE "+jComboBox1.getSelectedItem()+" SET  "+"`"+cl2.getText()+"`"+"="+st2.getText()+" , "+"`"+cl3.getText()+"`"+"="+st3.getText()+"  WHERE ";
            }
            else if(st1.getText().isEmpty()&& st2.getText().isEmpty()&&st3.getText().isEmpty()==false&&st4.getText().isEmpty()==false)
            {
                sql="UPDATE "+jComboBox1.getSelectedItem()+" SET  "+"`"+cl3.getText()+"`"+"="+st3.getText()+" ,"+"`"+cl4.getText()+"`"+"="+st4.getText()+"  WHERE ";
            }
           else if(st1.getText().isEmpty()==false&& st2.getText().isEmpty()==false&&st3.getText().isEmpty()==false&&st4.getText().isEmpty())
            {
                sql="UPDATE "+jComboBox1.getSelectedItem()+" SET  "+"`"+cl1.getText()+"`"+"="+st1.getText()+" ,"+"`"+cl2.getText()+"`"+"="+st2.getText()+","+"`"+cl3.getText()+"`"+"="+st3.getText()+ "  WHERE ";
            }
            else if(st1.getText().isEmpty()==false&& st2.getText().isEmpty()==false&&st3.getText().isEmpty()&&st4.getText().isEmpty()==false)
            {
                sql="UPDATE "+jComboBox1.getSelectedItem()+" SET  "+"`"+cl1.getText()+"`"+"="+st1.getText()+" , "+"`"+cl2.getText()+"`"+"="+st2.getText()+" ,"+"`"+cl4.getText()+"`"+"="+st4.getText()+ "  WHERE ";
            }
           else if(st1.getText().isEmpty()&& st2.getText().isEmpty()==false&&st3.getText().isEmpty()==false&&st4.getText().isEmpty()==false)
            {
                sql="UPDATE "+jComboBox1.getSelectedItem()+" SET  "+"`"+cl2.getText()+"`"+"="+st2.getText()+","+"`"+cl3.getText()+"`"+"="+st3.getText()+","+"`"+cl4.getText()+"`"+"="+st4.getText()+ "  WHERE ";
            }
            else if(st1.getText().isEmpty()==false&& st2.getText().isEmpty()==false&&st3.getText().isEmpty()==false&&st4.getText().isEmpty()==false)
            {
                sql="UPDATE "+jComboBox1.getSelectedItem()+" SET  "+"`"+cl1.getText()+"`"+"="+st1.getText()+" , "+"`"+cl2.getText()+"`"+"="+st2.getText()+" ,"+"`"+cl3.getText()+"`"+"="+st3.getText()+","+"`"+cl4.getText()+"`"+"="+st4.getText()+ "  WHERE ";
            }
